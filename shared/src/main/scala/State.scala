      ...
      "platform_top" -> SegmentFamily(
        ...
        children = Map(
          "platform_top" -> Segment(
            pattern = Vector(Vector("P", "P"), Vector(".", "."))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
      ...
      "platform_bottom" -> SegmentFamily(
        ...
        children = Map(
          "platform_bottom" -> Segment(
            pattern = Vector(Vector(".", "."), Vector("P", "P"))
          ),
          "platform_bottom_spike" -> Segment(
            pattern = Vector(Vector(".", "S"), Vector("P", "P"))
          ),
          "platform_bottom_checkpoint" -> Segment(
            pattern = Vector(Vector("C", "."), Vector("P", "P"))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
      ...
      "platform_left" -> SegmentFamily(
        ...
        children = Map(
          "platform_left" -> Segment(
            pattern = Vector(Vector("P", "."), Vector("P", "."))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
      ...
      "platform_full" -> SegmentFamily(
        ...
        children = Map(
          "platform_full" -> Segment(
            pattern = Vector(Vector("P", "P"), Vector("P", "P"))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
      ...
      "platform_diag1" -> SegmentFamily(
        ...
        children = Map(
          "platform_diag1" -> Segment(
            pattern = Vector(Vector("P", "."), Vector("P", "P"))
          ),
          "platform_diag1_checkpoint" -> Segment(
            pattern = Vector(Vector("P", "C"), Vector("P", "P"))
          ),
          "platform_diag1_spike" -> Segment(
            pattern = Vector(Vector("P", "S"), Vector("P", "P"))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
      ...
      "platform_diag2" -> SegmentFamily(
        ...
        children = Map(
          ...
          "platform_diag2_checkpoint" -> Segment(
            pattern = Vector(Vector("C", "P"), Vector("P", "P"))
          ),
          "platform_diag2_spike" -> Segment(
            pattern = Vector(Vector("S", "P"), Vector("P", "P"))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
      ...
      "platform_cube_top_right" -> SegmentFamily(
        ...
        children = Map(
          "platform_cube_top_right" -> Segment(
            pattern = Vector(Vector(".", "P"), Vector(".", "."))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
      ...
      "platform_cube_bottom_right" -> SegmentFamily(
        ...
        children = Map(
          "platform_cube_bottom_right" -> Segment(
            pattern = Vector(Vector(".", "."), Vector(".", "P"))
          ),
          "platform_cube_bottom_right_checkpoint" -> Segment(
            pattern = Vector(Vector(".", "C"), Vector(".", "P"))
          ),
          "platform_cube_bottom_right_spike" -> Segment(
            pattern = Vector(Vector(".", "S"), Vector(".", "P"))
          )
        ),
        right_weights = Map(
          "empty" -> 1.00f,
